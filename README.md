...
```
> Alternativa: em vez do `FakeSSMain`, podes popular o DHT **pelo nosso SS** — qualquer `event`
> enviado por um dispositivo é ingerido no DHT (carimbado com a zona do nó SS). Ver fim desta secção.
